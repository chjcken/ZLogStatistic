 ...
 * @author datbt
 */
public class ZAppReturnVisitorObj extends ZObject implements Serializable{
    ...
    @Override
    public ZAppReturnVisitorObj parseFromLogLine(String logline) {
